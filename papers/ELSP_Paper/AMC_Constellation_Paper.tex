...
[11] Dosovitskiy, A., et al. An image is worth 16x16 words: Transformers for image recognition at scale. \textit{ICLR} 2021.

[12] Liu, Z., et al. Swin transformer: Hierarchical vision transformer using shifted windows. \textit{ICCV} 2021.

[13] Peng, S., et al. Modulation classification using constellation diagrams in practical SNR ranges. \textit{IEEE Wireless Communications Letters} 2023, 12(4), 589-593.

[14] Kumar, V., et al. Automatic modulation classification: A deep learning enabled approach. \textit{IEEE Transactions on Vehicular Technology} 2023, 72(2), 1678-1690.

[15] West, N. E., O'Shea, T. J. Deep architectures for modulation recognition. \textit{IEEE International Symposium on Dynamic Spectrum Access Networks (DySPAN)} 2017, 1-6.

[16] Zhang, D., et al. Automatic modulation classification based on deep learning for unmanned aerial vehicles. \textit{Sensors} 2021, 21(21), 7221.

[17] Bengio, Y., Louradour, J., Collobert, R., Weston, J. Curriculum learning. \textit{ICML} 2009.
